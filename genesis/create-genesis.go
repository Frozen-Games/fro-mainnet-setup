...
var localNetConfig = genesisConfig{
	...
	Deployers: []common.Address{
		common.HexToAddress("0xb2c1f95256f0b24fbfe18c22cea19b939962311a"),
	},
	...
	SystemTreasury: map[common.Address]uint16{
		common.HexToAddress("0xb2c1f95256f0b24fbfe18c22cea19b939962311a"): 10000,
	},
	...
	InitialStakes: map[common.Address]string{
		common.HexToAddress("0xb2c1f95256f0b24fbfe18c22cea19b939962311a"): "0x3635c9adc5dea00000", // 1000 eth
	},
	// owner of the governance
	VotingPeriod: 20, // 1 minute
	// faucet
	Faucet: map[common.Address]string{
		common.HexToAddress("0xb2c1f95256f0b24fbfe18c22cea19b939962311a"): "0x21e19e0c9bab2400000",
...
var devNetConfig = genesisConfig{
	...
	Validators: []common.Address{
		common.HexToAddress("0x8ed2bcb528cb9dd5ecdb42d7b17aa54effafe330"),
		common.HexToAddress("0x4ab961cd3486819b6c2f30dd10c702e2ce20c024"),
		common.HexToAddress("0x4138fd15176ac17668232d4b896b9e69beec0b63"),
		common.HexToAddress("0x736dcaefe5c757fd37076df58a029acd2ef649ef"),
		common.HexToAddress("0x7e6bc34eeed1bc87f748b6c42d8923312e7d9593"),
	},
	SystemTreasury: map[common.Address]uint16{
	...
	InitialStakes: map[common.Address]string{
		common.HexToAddress("0x8ed2bcb528cb9dd5ecdb42d7b17aa54effafe330"): "0x3635c9adc5dea00000", // 1000 eth
		common.HexToAddress("0x4ab961cd3486819b6c2f30dd10c702e2ce20c024"): "0x3635c9adc5dea00000", // 1000 eth
		common.HexToAddress("0x4138fd15176ac17668232d4b896b9e69beec0b63"): "0x3635c9adc5dea00000", // 1000 eth
		common.HexToAddress("0x736dcaefe5c757fd37076df58a029acd2ef649ef"): "0x3635c9adc5dea00000", // 1000 eth
		common.HexToAddress("0x7e6bc34eeed1bc87f748b6c42d8923312e7d9593"): "0x3635c9adc5dea00000", // 1000 eth
	},
	// owner of the governance
	VotingPeriod: 60, // 3 minutes
	// faucet
	Faucet: map[common.Address]string{
		common.HexToAddress("0xb2c1f95256f0b24fbfe18c22cea19b939962311a"): "0x21e19e0c9bab2400000",    // governance
		common.HexToAddress("0x00eb054cf7517217c43311bebc840c67b166502c"): "0x52b7d2dcc80cd2e4000000", // faucet (10kk)
	},
}
